...
<?php if(isset($message)): ?><p style="font: italic bold 2cm cursive,serif; color:green">  
ok   
</p>  
...
<p>  
在( <span id="sec" style="color:blue;font-weight:bold"><?php echo($waitSecond); ?></span> )秒后自动跳转，或直接点击 <a href="http://www.bkjia.com/PHPjc/javascript：window.location='<?php echo($jumpUrl); ?>'">这里</a> 跳转<br>  
<span style="display:block;text-decoration:underline;cursor:pointer;line-height:25px">停止</span>  
</p>  
</div>  
<script>  
